...
> 2026-04-28 晚间更新：本文记录的是修复前断点。当前最新运行口径以 `docs/系统运行总规范_20260428.md`、`config/schedule.json`、`config/calendar_subagent_schedules.json`、`scripts/generate_daily_report_payload.py`、`scripts/render_cards_html.py`、`scripts/send_daily_report.py` 为准。
>
